...
def ModelTrain(ModelType, CriterionType, device,LR):
    ...
    train_loader = torch.utils.data.DataLoader(train_df, transform=transforms.Compose([
                                                                    transforms.RandomHorizontalFlip(),
                                                                    transforms.RandomRotation(15),
                                                                    transforms.Scale(256),
                                                                    transforms.CenterCrop(256),
    ...
    val_loader = torch.utils.data.DataLoader(val_df, transform=transforms.Compose([transforms.Scale(256),
                                                                                    transforms.CenterCrop(256),
                                                                                    transforms.ToTensor(),
                                                                                    normalize]),
