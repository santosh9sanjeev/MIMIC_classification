...
if __name__ == '__main__':
    ...
    print(model)
    checkpoint_path = '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/MIMIC_classification/own_prep/checkpoints/MIMIC-densenet-best.pt'
    train_utils.validate(model, checkpoint_path, test_dataset, test_loader, device, args)
